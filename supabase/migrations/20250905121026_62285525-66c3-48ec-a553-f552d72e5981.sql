-- Solution pour permettre le déploiement : masquer les données GPS sensibles
-- tout en gardant la découverte des profils

-- 1. Supprimer la politique actuelle
DROP POLICY IF EXISTS "Profiles are viewable by authenticated users" ON public.profiles;

-- 2. Créer une politique qui masque les coordonnées GPS exactes
...
-- 3. Permettre la découverte des profils SANS les données sensibles
...
-- 4. Créer une fonction sécurisée qui ne retourne que les données nécessaires pour le matching
