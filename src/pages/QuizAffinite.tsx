    ...
    <div className="min-h-screen bg-gradient-to-b from-primary via-primary-dark to-primary-darker">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-white text-center mb-8">
          Découvre ton profil d'affinité
        </h1>
        
        {/* Quiz intégré */}
        <div className="rounded-lg shadow-lg mb-8">
          <iframe
            src="https://tally.so/embed/mONLrK?alignLeft=1&hideTitle=1&dynamicHeight=1"
            width="100%"
            height="600"
            frameBorder="0"
            marginHeight={0}
            marginWidth={0}
            title="Quiz Affinité Fabdive"
